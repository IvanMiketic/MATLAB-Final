function [ splinepv, r, splinerangeb ] = SwitchShellb ( tspan, A, radius, a, m, k,T, run, r, c)
...
[TT,w] = ode45(@mySecondDiff,tspan,R0,[],A,m, radius,a, L);
...
U = -A * exp (-(r_rand - radius).^2/a^2) + L.^2/(2*m.^2*r_rand.^2);
E = .5 * m * vo.^2 + U;
